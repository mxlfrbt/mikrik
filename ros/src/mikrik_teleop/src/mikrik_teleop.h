...
#ifndef MIKRIK_TELEOP_H_
#define MIKRIK_TELEOP_H_
...
class MikrikTeleop {
public:
	MikrikTeleop(ros::NodeHandle private_node);
...
MikrikTeleop::MikrikTeleop(ros::NodeHandle private_node)
	...
	_cmd_vel_pub = _node.advertise<geometry_msgs::Twist>("/mobile_mikrik/cmd_vel", 1);
	_joy_sub = _node.subscribe<sensor_msgs::Joy>("joy", 10, &MikrikTeleop::joyCallback, this);
	ROS_INFO("Mikrik teleop node: Start");
}

void MikrikTeleop::joyCallback(const sensor_msgs::Joy::ConstPtr& joy) {
